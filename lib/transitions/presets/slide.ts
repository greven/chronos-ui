...
export const createSlideConfig = (placement: SlidePlacement): Partial<TransitionConfig> => ({
  enter: {
...
export const createSlideBaseStyle = (placement: SlidePlacement) => placements[placement]
