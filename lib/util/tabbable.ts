// Credits: ChakraUI & https://github.com/reakit/reakit/blob/master/packages/reakit-utils/src/tabbable.ts

export const hasDisplayNone = (element: Element) =>
  window.getComputedStyle(element).display === 'none'

export const hasTabIndex = (element: Element) => element.hasAttribute('tabindex')
