...
export function getAllTabbable<T extends Element>(container: T, fallbackToFocusable?: boolean) {
...
export function focusNextTabbable<T extends Element>(container: T, fallbackToFocusable?: boolean) {
