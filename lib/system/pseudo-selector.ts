import { AnyFunction, objectKeys } from '../util'
...
const disabled = (selector: string) => `${selector}, ${selector}:focus, ${selector}:hover`

const disabledSelector = merge(disabled, '&[disabled]', '&[aria-disabled=true]', '&[data-disabled]')
...
export const pseudoSelectors = {
   ...
   *
   * When using this, ensure the `content` is wrapped in a backtick.
   * @example
   * ```jsx
   * <Box _before={{content:`""` }}/>
   * ```
